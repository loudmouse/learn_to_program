...
while number_bottles > 0
 puts "#{englishNumber(number_bottles).capitalize} bottles of beer on the wall! #{englishNumber(number_bottles).capitalize} bottles of beer! Take one down, pass it around, #{englishNumber(number_bottles-1)} bottles of beer on the wall!"
 number_bottles -= 1
end
