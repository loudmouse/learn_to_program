...
puts "Jim Carrey wrote himself a check for #{englishNumber(4000000)} dollars when he was a kid."
puts "Doctor Evil: Give me #{englishNumber(1000000000)} dollars."
puts "With the upcoming release of the iPhone X, Apple's value could surpass #{englishNumber(1000000000000)} dollars. Holy hell they've come a long way since the Apple Newton!"
